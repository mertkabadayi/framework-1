...
class MessageTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSubject()
    {
    	...
    	$this->assertInstanceOf('Pagekit\Mail\Message', $this->message->setSubject('some subject'));
    	$this->assertEquals('some subject', $this->message->getSubject());
    }

    public function testDate()
    {
    	$this->assertInstanceOf('Pagekit\Mail\Message', $this->message->setDate(20131212));
    ...
    public function testBody()
    {
    	...
    	$this->assertInstanceOf('Pagekit\Mail\Message', $this->message->setBody('some subject'));
    ...
    public function testReturnPath()
    {
    	...
    	$this->assertInstanceOf('Pagekit\Mail\Message', $this->message->setReturnPath('test@mail.com'));
    ...
    public function testSender()
    {
    	...
    	$this->assertInstanceOf('Pagekit\Mail\Message', $this->message->setSender('test@mail.com', 'test'));
    ...
    public function testFrom()
    {
    	...
    	$this->assertInstanceOf('Pagekit\Mail\Message', $this->message->setFrom('test@mail.com', 'test'));
    ...
    public function testReplyTo()
    {
    	...
    	$this->assertInstanceOf('Pagekit\Mail\Message', $this->message->setReplyTo('test@mail.com', 'test'));
    ...
    public function testTo()
    {
    	...
    	$this->assertInstanceOf('Pagekit\Mail\Message', $this->message->setTo('test@mail.com', 'test'));
     ...
     public function testCc()
    {
    	...
    	$this->assertInstanceOf('Pagekit\Mail\Message', $this->message->setCc('test@mail.com', 'test'));
    ...
    public function testBcc()
    {
    	...
    	$this->assertInstanceOf('Pagekit\Mail\Message', $this->message->setBcc('test@mail.com', 'test'));
    ...
    public function testAttach()
    {
    	...
    	$this->assertInstanceOf('Pagekit\Mail\Message', $this->message->attachFile('./Fixtures/foo.txt', 'Foo', 'text/plain'));
